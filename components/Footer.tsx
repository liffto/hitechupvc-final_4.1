        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="space-y-6">
            ...
            <div className="flex gap-3">
              ...
              <a href={`tel:${settings.adminPhone}`} className="bg-primary/20 text-primary p-3 rounded-xl hover:bg-primary hover:text-white transition-all border border-primary/30"><Phone size={20} /></a>
