      ...
      <div className="max-w-7xl mx-auto px-6 md:px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-3 md:space-y-4">
            ...
            <a href={`tel:${settings.adminPhone}`} className="flex items-center justify-between bg-white border-2 border-gray-50 p-3.5 rounded-2xl shadow-sm hover:shadow-lg transition-all group active:scale-95">
               <div className="flex items-center gap-3 md:gap-4">
